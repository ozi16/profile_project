<div class="fixed bottom-0 w-full bg-white shadow-lg py-4 md:hidden glow">
    <div
        class="border container max-w-5xl mx-auto grid grid-cols-5 gap-4 justify-items-center">
        <a href="../content/home.php" class="flex flex-col items-center text-green-500">
        ...
        <a
            ...
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                <title></title>
